...
<p align="center">
  <img src="screenshots/dashboard-overview.png" alt="SBA loan risk dashboard overview" width="850">
</p>

<p align="center">
  <a href="https://datastudio.google.com/reporting/ae835611-422a-4b42-816d-1a73065ab196"><strong>Open Live Dashboard →</strong></a>
</p>

> **Note:** if the link above prompts you to request access instead of opening directly, the report's sharing setting needs to be switched to public — see the "Fixing the live link" note I sent alongside this file.
